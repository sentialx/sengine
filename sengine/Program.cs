...
namespace sengine {
    class Program {
        static void Main(string[] args) {
            string html = @"<html><!-- aha --><head><title>Test</title></head><body><br /><a>test</a><input disabled=""true""value=yes type=""checkbox xd""disabled aha>s<b>Bold text</b></body></html>";
